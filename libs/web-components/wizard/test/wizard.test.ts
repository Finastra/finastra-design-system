...
describe('Wizard', () => {
  ...
  it('should go to next step', async () => {
    ...
    <fds-wizard>
      ...
      <fds-wizard-page slot="page" title="Confirmation" description="Confirmation page">
      </fds-wizard-page>
    </fds-wizard>`);
  ...
  it('should go to previous step', async () => {
    ...
    <fds-wizard>
      ...
      <fds-wizard-page current slot="page" title="Confirmation" description="Confirmation page">
      </fds-wizard-page>
    </fds-wizard>`);
