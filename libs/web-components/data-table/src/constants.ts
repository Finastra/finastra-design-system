...
export const FDS_TABLE_HEADER_CHECKBOX = 'fds-table-header-checkbox';
export const FDS_TABLE_ROW_CHECKBOX_SUFFIX = '-checkbox';

export const FDS_TABLE_HEADER_RADIO = 'fds-table-header-checkbox';
export const FDS_TABLE_ROW_RADIO_SUFFIX = '-checkbox';

export const FDS_TABLE_RADIO_GROUP = 'fds-table-radio-group';
